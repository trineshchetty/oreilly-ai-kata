...
COPY products ("product_id", "product_name", "merchant_id", "cluster_id", "cluster_label", "category_id", "category", "price", "stock_quantity", "description", "rating")
\FROM '/home/trinesh/work/oml/oreilly-ai-kata/data/synthetic-product-data.csv' DELIMITER ',' CSV HEADER;


COPY orders ("product_id", "product_name", "category", "category_id", "order_id", "customer_id", "order_status", "return_eligible", "shipping_date")
FROM '/home/trinesh/work/oml/oreilly-ai-kata/data/synthetic-orders-data.csv' DELIMITER ',' CSV HEADER;
